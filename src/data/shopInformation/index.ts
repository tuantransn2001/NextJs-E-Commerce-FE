export const infoStoryImgStyleObj = {
  display: 'block',
  margin: 'auto',
  width: '100%',
  maxHeight: '350px',
...
export const lenleysStoriesData = [
  {
    direction: 'row',
    paragraph: {
      heading:
    ...
    imgSrc:
      'https://www.lenleys.co.uk/wp-content/uploads/2022/03/Lenleys-Roper-Rd-Partners-celebration.jpg',
    slogan: '',
  },
  {
    ...
    imgSrc:
      'https://www.lenleys.co.uk/wp-content/uploads/2022/03/LENLEYS-3074-scaled.jpg',
    slogan: '“WE’RE PROOF THAT LOCAL FAMILY-RUN BUSINESSES CAN STILL THRIVE.”',
  },
];

export const bannerImgSrc = [
  'https://www.lenleys.co.uk/wp-content/uploads/2022/03/Summerton.png',
  'https://www.lenleys.co.uk/wp-content/uploads/2022/03/Somnus-Legacy-Collection-Alnwick-12000-2-2-768x422.jpg',
  'https://www.lenleys.co.uk/wp-content/uploads/2022/03/7397-768x768.jpg',
];
